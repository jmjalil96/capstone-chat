...
export async function preloadDraftContext(
  ...
  const result = await database.execute<DraftContextPreloadRow>(sql`
    ...
    SELECT
      ...
      NULL AS "policyRevision",
      NULL AS "promptPricePerToken",
      NULL AS "reasoningBudgetTokens",
      NULL AS "reasoningDefaultEffort",
      NULL AS "reasoningDefaultEnabled",
      NULL AS "reasoningEffort",
      NULL AS "reasoningEffortSupportKind",
      NULL AS "reasoningEfforts",
      NULL AS "reasoningMaxTokensAccepted",
      NULL AS "reasoningMode",
      NULL AS "reasoningTraceSafety",
      NULL AS "requestPriceUsd",
      NULL AS "reservationMarginBasisPoints",
      NULL AS "resolvedModel",
      NULL AS "temperaturePreset",
      NULL AS "temperatureSupported",
      NULL AS tier
    ...
    SELECT
      ...
      policy_preload."policyRevision",
      policy_preload."promptPricePerToken",
      policy_preload."reasoningBudgetTokens",
      policy_preload."reasoningDefaultEffort",
      policy_preload."reasoningDefaultEnabled",
      policy_preload."reasoningEffort",
      policy_preload."reasoningEffortSupportKind",
      policy_preload."reasoningEfforts",
      policy_preload."reasoningMaxTokensAccepted",
      policy_preload."reasoningMode",
      policy_preload."reasoningTraceSafety",
      policy_preload."requestPriceUsd",
      policy_preload."reservationMarginBasisPoints",
      policy_preload."resolvedModel",
      policy_preload."temperaturePreset",
      policy_preload."temperatureSupported",
      policy_preload.tier
    FROM policy_preload
  `);
