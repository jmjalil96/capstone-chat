...
describe.sequential("employee and usage administration integration", () => {
  ...
  it("groups only current-month accounting and exposes no conversation content", async () => {
    ...
    await seedGeneration({
      ...accountingSnapshot(period, at, "0.5"),
      accountingSettledAt: settledAt,
      accountingStatus: "actual",
      cachedTokens: 1n,
      completedAt: settledAt,
      ...
      purpose: "title",
      reasoningTokens: 0n,
      requestedModel: "fixture/title-model",
      requestedTier: "fast",
      resolvedModel: "fixture/title-model",
      startedAt: at,
      status: "completed",
      systemPromptVersion: "capstone-title-v1",
      terminalReason: "stop",
      updatedAt: settledAt,
      userId: employee.userId,
      workspaceId,
      ...
      items: [
        {
          ...
          softBudget: { consumedUsd: "6.5", monthlyBudgetUsd: "6", warning: true },
        },
      ],
      nextCursor: null,
    });
